...
from kipl_ml.models.trgen import TRGEN5
...
def run_g_steps(
    ...
    for _ in range(n_steps):
        ...
        X[Feats.DIR_PROBS] = torch.cat(
            (X[Feats.DIR_PROBS], dir_probs[:, -1:, :]), dim=1
        )
...
def main(cfg: DictConfig):
    ...
    generator = TRGEN5(features=[Feats.DIR_PROBS], hsize=256, nlayer=2)
