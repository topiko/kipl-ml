...
other_bottle=("front-bottleneck" "interspace" "breakpad" "regulator-bottleneck" "tamaraw-bottleneck")
other_inf=("front-infinite" "interspace" "breakpad" "regulator-infinite" "tamaraw-infinite")
